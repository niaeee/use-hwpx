...
def main() -> None:
    ...
    if not os.path.isdir(args.input):
        ...
        print("  Provide a valid directory path (typically from unpack.py output).", file=sys.stderr)
        sys.exit(1)
    ...
    try:
        ...
        print("  The directory must contain a 'mimetype' file to be a valid HWPX source.", file=sys.stderr)
        sys.exit(1)
